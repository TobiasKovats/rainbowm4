...
#define CRYPTO_ALGNAME "RAINBOW(16,36,32,32) - cyclic compressed"

int crypto_sign_keypair(unsigned char *pk, unsigned char *sk, unsigned char *pkseed, unsigned char *sk_seed);
